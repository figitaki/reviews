...
The packet has a lifecycle — draft, in review, approved — that matches the agent loop. Per-reviewer progress (which hunks they have covered, which testing tasks they have run) carries across patchset updates via content-hash anchoring. Push a new patchset, and partial review work survives.
